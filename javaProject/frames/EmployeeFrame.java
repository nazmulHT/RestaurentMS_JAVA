...
public class EmployeeFrame extends JFrame implements ActionListener
{
	...
	public EmployeeFrame(User user)
	{
		...
		empIdTF.setBackground(Color.CYAN);
		panel.add(empIdTF);
		
		empNameLabel = new JLabel("Name :");
		empNameLabel.setBounds(100,150,100,30);
		empNameLabel.setBackground(Color.GREEN);
		panel.add(empNameLabel);
		
		empNameTF = new JTextField();
		empNameTF.setBounds(220,150,100,30);
		empNameTF.setBackground(Color.GREEN);
		empNameTF.setForeground(Color.BLUE);
		panel.add(empNameTF);
		
		empDesignationLabel = new JLabel("Designation: ");
		empDesignationLabel.setBounds(100,200,100,30);
		empDesignationLabel.setBackground(Color.CYAN);
		empDesignationLabel.setForeground(Color.RED);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(command.equals(insertBtn.getText()))
		{
			...
			else if(((empDesignationTF.getText()).equals("Supervisor")) || ((empDesignationTF.getText()).equals("supervisor")))
			{
				u.setStatus(1);
			}
